...
void plot_HeD()
{
   ...
   for(int ii=0;ii<11;ii++){
	   ...
	   if(He3_x[ii][jj]==0)continue;
           ...
           if(He3_Rad[ii][jj]>0&&D2_Rad[ii][jj]>0)Dp_RC[ii][jj]=(He3_Born[ii][jj]/He3_Rad[ii][jj])/(D2_Born[ii][jj]/D2_Rad[ii][jj]);
           hRC->SetPoint(nn,He3_x[ii][jj],Dp_RC[ii][jj]);

           hborn1->SetPoint(nn,He3_x[ii][jj],He3_Born1[ii][jj]/D2_Born1[ii][jj]);
           hrad1->SetPoint(nn,He3_x[ii][jj],He3_Rad1[ii][jj]/D2_Rad1[ii][jj]);
           if(He3_Rad1[ii][jj]>0&&D2_Rad1[ii][jj]>0)Dp_RC1[ii][jj]=(He3_Born1[ii][jj]/He3_Rad1[ii][jj])/(D2_Born1[ii][jj]/D2_Rad1[ii][jj]);
           hRC1->SetPoint(nn,He3_x[ii][jj],Dp_RC1[ii][jj]);

           if(Dp_RC1[ii][jj]>0)Dp_ratio[ii][jj]=Dp_RC[ii][jj]/Dp_RC1[ii][jj];
           hratio->SetPoint(nn,He3_x[ii][jj],Dp_ratio[ii][jj]);
           nn++;
       }
   } 
   ...
   mg2->Add(hrad1);
   mg2->Draw("AP");
   mg2->SetTitle("He3/D rad cross section ratio;xbj;rad");
   ...
   mg3->Add(hRC1);
   mg3->Draw("AP");
   mg3->SetTitle("He3/D RC=born/rad ratio;xbj;RC");
   ...
   hratio->Draw("AP");
   hratio->SetTitle("He3/D Bodek/model111 ratio;xbj;"); 
