...
void plot_Dp()
{
   ...
   int kin[5]={0,1,2,3,4};
   for(int ii=0;ii<5;ii++){
       Yfile=Form("Model_Comparison/model111/D2_kin%d_xs.out",kin[ii]);
       ...
       Yfile=Form("Model_Comparison/model111/H1_kin%d_xs.out",kin[ii]);
...
//   mg2->Add(hrad1);
   ...
   hratio->Draw("AP");
   hratio->SetTitle("Dp model111/Bodek ratio;xbj;"); 
