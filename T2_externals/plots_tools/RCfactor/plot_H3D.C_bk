...
void plot_H3D()
{
   ...
   for(int ii=0;ii<11;ii++){
	   ...
	   if(H3_x[ii][jj]==0)continue;
           ...
           if(H3_Rad[ii][jj]>0&&D2_Rad[ii][jj]>0)Dp_RC[ii][jj]=(H3_Born[ii][jj]/H3_Rad[ii][jj])/(D2_Born[ii][jj]/D2_Rad[ii][jj]);
           ...
           if(H3_Rad1[ii][jj]>0&&D2_Rad1[ii][jj]>0)Dp_RC1[ii][jj]=(H3_Born1[ii][jj]/H3_Rad1[ii][jj])/(D2_Born1[ii][jj]/D2_Rad1[ii][jj]);
   ...
   hratio->Draw("AP");
   hratio->SetTitle("H3/D Bodek/model111 ratio;xbj;"); 
