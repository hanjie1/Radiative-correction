...
void plot_yield()
{
     ...
     Double_t He3_Born2[10][MAXBIN],He3_Rad2[10][MAXBIN],He3_Born3[10][MAXBIN],He3_Rad3[10][MAXBIN];
     ...
     Double_t H3_Born2[10][MAXBIN],H3_Rad2[10][MAXBIN],H3_Born3[10][MAXBIN],H3_Rad3[10][MAXBIN];
	 ...
	 for(int jj=0;jj<MAXBIN;jj++){
		...
		H1_x[ii][jj]=0.0; H1_Q2[ii][jj]=0.0; H1_Yield[ii][jj]=0.0; H1_Yerr[ii][jj]=0.0;
	     ...
	     He3_x[ii][jj]=0.0; He3_Q2[ii][jj]=0.0; He3_Yield[ii][jj]=0.0; He3_Yerr[ii][jj]=0.0;
             ...
             He3_Born2[ii][jj]=0.0; He3_Rad2[ii][jj]=0.0;He3_Born3[ii][jj]=0.0; He3_Rad3[ii][jj]=0.0;
	     H3_x[ii][jj]=0.0; H3_Q2[ii][jj]=0.0; H3_Yield[ii][jj]=0.0; H3_Yerr[ii][jj]=0.0;
             ...
             H3_Born2[ii][jj]=0.0; H3_Rad2[ii][jj]=0.0;H3_Born3[ii][jj]=0.0; H3_Rad3[ii][jj]=0.0;
     }}
   ...
   while(KIN<16){
       ...
       RCfile=Form("F2ALLM/D2_kin%d_xs.out",KIN);
  ...
  for(int ii=0;ii<10;ii++){
      ...
      for(int jj=0;jj<MAXBIN;jj++){
          ...
          gRatio_1[ii]->SetPoint(nn,D2R_x[ii][jj],D2_Born1[ii][jj]/D2_Born2[ii][jj]);
          //gRatio_2[ii]->SetPoint(nn,D2R_x[ii][jj],(D2_Born2[ii][jj]/D2_Rad2[ii][jj])/(D2_Born3[ii][jj]/D2_Rad3[ii][jj]));
          gRatio_2[ii]->SetPoint(nn,D2R_x[ii][jj],D2_Born2[ii][jj]/D2_Born3[ii][jj]);
          nn++;
      }
  }
  ...
  leg2->AddEntry(gD2RC3[0],"F2ALLM","P");
  leg2->Draw();
  ...
  leg3->AddEntry(gD2Born3[0],"F2ALLM","P");
  leg3->Draw();
  ...
  leg4->AddEntry(gD2Rad3[0],"F2ALLM","P");
  leg4->Draw();
  ...
  mg5->SetTitle("D2 born cross section ratio;x;");
  ...
  leg6->AddEntry(gRatio_2[0],"INEFT/F2ALLM","P");
  leg6->Draw();
