...
void plot_D2_1()
{
   ...
   while(KIN<16){
       ...
       RCfile=Form("Bodek_newbin_withIon/D2_kin%d_xs.out",KIN);
  ...
  for(int ii=0;ii<11;ii++){
      ...
      for(int jj=0;jj<MAXBIN;jj++){
          ...
          gD2Raw[ii]->SetPoint(nn,D2R_x[ii][jj],D2_Yield[ii][jj]);
  ...
  int nn=1;
  for(int ii=0;ii<11;ii++){
      if(ii<6)leg1->AddEntry(gD2Raw[ii],Form("D2 kin%d",ii),"P");
  ...
  for(int ii=0;ii<11;ii++){
      ...
      gD2RC1[ii]->SetMarkerColor(ii+1);
      mg2->Add(gD2RC1[ii]);
      gD2RC2[ii]->SetMarkerStyle(22);
      gD2RC2[ii]->SetMarkerSize(1.5);
      gD2RC2[ii]->SetMarkerColor(ii+1);
      mg2->Add(gD2RC2[ii]);
  }
  mg2->Draw("AP");
  ...
  for(int ii=0;ii<11;ii++){
      ...
      gD2Born1[ii]->SetMarkerColor(ii+1);
      mg3->Add(gD2Born1[ii]);
      gD2Born2[ii]->SetMarkerStyle(22);
      gD2Born2[ii]->SetMarkerSize(1.5);
      gD2Born2[ii]->SetMarkerColor(ii+1);
      mg3->Add(gD2Born2[ii]);
  }
  mg3->Draw("AP");
  ...
  for(int ii=0;ii<11;ii++){
      ...
      gD2Rad1[ii]->SetMarkerColor(ii+1);
      mg4->Add(gD2Rad1[ii]);
      gD2Rad2[ii]->SetMarkerStyle(22);
      gD2Rad2[ii]->SetMarkerSize(1.5);
      gD2Rad2[ii]->SetMarkerColor(ii+1);
      mg4->Add(gD2Rad2[ii]);
  }
  mg4->Draw("AP");
