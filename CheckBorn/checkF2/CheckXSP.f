        ...
        infile='../data/XSp_Whitlow.dat'
        write(6,*) infile

        OPEN(UNIT=7,FILE=infile)
        READ(7,'(A72)') COMMENT

        outfile='OUT/P_Whitlow_newrescsp.out'
