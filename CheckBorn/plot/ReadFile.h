#define MAXBIN 35
TString Yieldpath="/home/hanjie/work/MARATHON/RadCor/CheckBorn/OUT/";
int ReadYield(TString filename,int kin,Double_t x[][MAXBIN],Double_t Q2[][MAXBIN],Double_t Born[][MAXBIN]){
    ifstream file;
